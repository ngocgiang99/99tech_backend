...
|-----------------------------------|-------------------------------------------------------------------|-----------------------------------------------------|
| `GET /api/v1/resources/:id` — cache HIT  | [docs/architecture/get-cache-hit.md](./docs/architecture/get-cache-hit.md)         | Understand the fast path                            |
| `GET /api/v1/resources/:id` — cache MISS | [docs/architecture/get-cache-miss.md](./docs/architecture/get-cache-miss.md)       | Understand the slow path + singleflight             |
| `POST /api/v1/resources`                 | [docs/architecture/post.md](./docs/architecture/post.md)                           | Understand write + list-cache invalidation          |
| `PATCH /api/v1/resources/:id`            | [docs/architecture/patch.md](./docs/architecture/patch.md)                         | Understand partial update + detail-cache `DEL`      |
| `DELETE /api/v1/resources/:id`           | [docs/architecture/delete.md](./docs/architecture/delete.md)                       | Understand hard delete + invalidation               |
...
|--------------------------------------------|----------------------------------------------------------|-----------------------------------------------|------------------------------------|----------------------|
| `resource:v1:id:{uuid}`                    | `resource:v1:id:7f3c…`                                   | Detail cache for `GET /api/v1/resources/:id`         | `CACHE_DETAIL_TTL_SECONDS` (300 s) | `DEL` on `PATCH` / `DELETE` of that id; TTL self-heals on `POST` (no DEL needed) |
...
src/modules/resources/index.ts        (module factory)
      │
      ▼   returns { router }
   const v1 = Router(); v1.use('/resources', router)
   app.use('/api/v1', v1)
